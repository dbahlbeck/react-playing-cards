...
function PlayingCard(props) {
    ...
    return (
        <Image scaleY={0.5} scaleX={0.5} shadowEnabled={lifted} shadowOffsetX={10} shadowOffsetY={10}
               shadowOpacity={0.2} image={props.card.faceDown ? backImage : frontImage}
               x={props.card.x} y={props.card.y}
